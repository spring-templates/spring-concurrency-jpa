...
public class OrderServiceTest {
    ...
    public void shouldProductStockException(){
        ...
        Assertions.assertThrows(BaseException.class, () -> orderService.validateCoreProducts(requireStock));
    }
    @Test
    public void shouldProductStockPass(){
        ...
        Assertions.assertDoesNotThrow(() -> orderService.validateCoreProducts(requireStock));
    }
}
